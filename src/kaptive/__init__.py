...
class KaptiveWarning(Warning):
    ...
    Examples:
        >>> import warnings
        >>> from kaptive import KaptiveWarning
        ... warnings.simplefilter('ignore', KaptiveWarning)
    """

    pass


class DependencyWarning(KaptiveWarning):
...
# Constants ------------------------------------------------------------------------------------------------------------
RESOURCES = Resources('numpy', 'edlib', 'scikit-learn')
